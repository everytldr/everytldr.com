-- Based on Spring Batch 6.0.3 org/springframework/batch/core/schema-mysql.sql.
-- Managed by Flyway so MySQL environments do not depend on runtime schema initialization.
