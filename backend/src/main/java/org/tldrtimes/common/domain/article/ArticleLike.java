...
@Table(uniqueConstraints = @UniqueConstraint(name = "uk_article_like_article_ip", columnNames = {
        "article_id",
        "ip_hash" }), indexes = @Index(name = "idx_article_like_article_active", columnList = "article_id, is_active"))
public class ArticleLike extends BaseEntity {

    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "article_id", nullable = false, foreignKey = @ForeignKey(name = "fk_article_like_article"))
