...
import org.tldrtimes.ingestor.batch.ArticleIngestionBatchConfig;

@Component
@Profile("ingestor")
@ConditionalOnProperty(name = "tldrtimes.ingestor.ingestion.enabled", havingValue = "true")
@Slf4j
public class ArticleIngestionScheduler {
  ...
  @Scheduled(fixedDelayString = "${tldrtimes.ingestor.ingestion.fixed-delay}")
