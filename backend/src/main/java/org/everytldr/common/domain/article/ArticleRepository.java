...
public interface ArticleRepository extends JpaRepository<Article, Long> {
  ...
  @Query(
      """
      SELECT new org.everytldr.common.domain.article.ArticleRepository$DetailProjection(
          a.id,
          s.title,
          s.content,
          a.thumbnailUrl,
  ...
  @Query(
      """
      SELECT new org.everytldr.common.domain.article.ArticleRepository$ListItemProjection(
