...
class SoftDeleteTest {
    ...
    void softDeletedArticleIsHiddenFromFindById() {
        Article article = articleRepository.saveAndFlush(Article.create(
    ...
    void softDeletedArticleIsHiddenFromFindAll() {
        Article kept = articleRepository.saveAndFlush(Article.create(
                "https://example.com/keep",
                "Example",
                null,
                "en",
                null));
        Article deleted = articleRepository.saveAndFlush(Article.create(
    ...
    void softDeletedCommentIsHiddenFromFindById() {
        ...
        ArticleComment comment = commentRepository.saveAndFlush(ArticleComment.createTopLevel(
                article,
                "guest",
